...
dict_v11 = os.path.join(base_path, "Dictionary of soft skills (11).xlsx")
json_input = os.path.join(base_path, "Yearly_Job_Posts_2016_2020.json")
output_path = os.path.join(base_path, "v11_AllOccurrences_2016_2020.json")

# === LOAD DICTIONARY ===
dict_df = pd.read_excel(dict_v11)
...
# === PROCESS OCCURRENCES ===
results = {}
for year in tqdm(sorted(yc_data.keys()), desc="Counting V11 Skills (2016–2020)"):
...
print(f"✅ Saved v11 (2016–2020) results to: {output_path}")
