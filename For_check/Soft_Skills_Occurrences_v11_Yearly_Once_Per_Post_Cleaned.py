...
# File path for v11 JSON file
file_path = r"C:\Users\negin\YC-Job-Analytics\Result_YC\March 2025\Soft_Skills_Occurrences_v11_Yearly_Once_Per_Post_Cleaned.json"
...
plt.title("Normalized Soft Skills as a Percentage of Job Posts (v11)")
plt.xlabel("Year")
...
# Save the plot
output_file = f"{output_folder}\\Normalized_Soft_Skills_v11.png"
