...
def count_occurrences():
    ...
    for year in data['YC']:
        ...
        for i in tqdm(range(0, len(comments), batch_size), desc=f"Processing {year}"):
            ...
            for j, subcategory in enumerate(subcategories):
                if subcategory and subcategory != "responsibility":  # Skip empty strings and "responsibility"
    ...
    # Save results
    output_file = os.path.join(script_dir, "count_11_without_responsibility.xlsx")
