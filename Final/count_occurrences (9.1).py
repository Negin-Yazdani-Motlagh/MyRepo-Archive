...
def count_occurrences():
    ...
    for year in data['YC']:
        ...
        for i in tqdm(range(0, len(comments), batch_size), desc=f"Processing {year}"):
            ...
            for j, subcategory in enumerate(subcategories):
                if subcategory and subcategory != "responsible":  # Skip empty strings and "responsible"
    ...
    # Save results
    output_file = os.path.join(script_dir, "Dictionary of soft skills (9.1)_without_responsible.xlsx")
